            ...
            <div class="item active">
                <div class="row">
                    <div class="col-sm-4">
                      ...
                      <a href="./work1.jsp" title="" class="black-image-project-hover">
                        <img src="./assets/images/verni0.png" alt="" class="img-responsive">
                      </a>
                      <div class="card-container card-container-lg">
                        <h4>001</h4>
                        <h3>명품대여 쇼핑몰</h3>
                        <p>가장 최근에 완성한 프로젝트입니다. 기획부터 개발까지 제 성장에 큰 기여를 한 프로젝트입니다.</p>
                        <a href="./work1.jsp" title="" class="btn btn-default">더 자세히</a>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <a href="./work2.jsp" title="" class="black-image-project-hover">
                        <img src="./assets/images/goback2-.png" alt="" class="img-responsive">
                      </a>
                      <div class="card-container card-container-lg">
                        <h4>002</h4>
                        <h3>고민상담소 고백</h3>
                        <p>고민을 털어 놓고, 상담해주는 고민상담 커뮤니티입니다.<br> 2주동안 구현한 세미프로젝트 결과물입니다.</p>
                        <a href="./work2.jsp" title="" class="btn btn-default">더 자세히</a>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <a href="#" title="" class="black-image-project-hover">
                        <img src="./assets/images/etc0-.jpg" alt="" class="img-responsive">
                      </a>
                      <div class="card-container card-container-lg">
                        <h4>003</h4>
                        <h3>앞으로 채워나갈 공간입니다.</h3>
                        <p>새 프로젝트를 완성하여 <br> 빠른 시일 내에 업데이트 하고 싶습니다.</p>
