...
<!-- Add your site or app content here -->
  <div class="hero-full-container background-image-container white-text-container" style="background-image: url('./assets/images/home.jpg'); width: 100%; height: 100%">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
            ...
            <div class="text-content">
              <h1>안녕하세요!<br>
                <span id="typed-strings" >
                  <span>저는 강은지입니다.</span>
                  <span>신입 개발자입니다.</span>
                  <span>배움을 즐거워하는 개발자가<br>되고 싶습니다.</span>
                </span>
                <span id="typed"></span>
              </h1>
            </div>
